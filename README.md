...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/emanuelcruvinel/wave_attenuation/master?urlpath=/proxy/5006/bokeh-app)
...
5. Created a Binder link that uses `urlpath` to point users to the port on which the Bokeh server will run:
   ...
   ```
   https://mybinder.org/v2/gh/emanuelcruvinel/wave_attenuation/master?urlpath=/proxy/5006/bokeh-app
   ```
